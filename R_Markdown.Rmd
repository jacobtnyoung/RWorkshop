---
title: "Data-Driven Documents: R Markdown"
...
![file call image](_images/markdown_file_pic.png)  
<br>
...
![file call image](_images/knit_pic.png) 
<br>
...
Here is another example. Take a look through the [R2PhX](https://jacobtnyoung.github.io/R2PhX/) pages. In particular, take a look at this page examining [crime in Phoenix](https://jacobtnyoung.github.io/R2PhX/projects/PHXcrime_trends.html). This page is a .html file that is created using an RMarkdown file. That file can be found [here](https://github.com/jacobtnyoung/R2PhX/blob/master/projects/PHXcrime_trends.Rmd).
