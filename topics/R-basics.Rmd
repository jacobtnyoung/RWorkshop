...
Good question. Watch this [video](https://player.vimeo.com/video/180644880) for a 1 minute answer.  
...
Go to [http://cran.r-project.org](http://cran.r-project.org). Find the "Download R for..." link that is appropriate for your operating system. *Mac users*: Do you have an Intel chip or an Apple chip? Be sure you download the version of R that corresponds to your chip manufacturer.
...
# what is the fourth element in y?
y[4]
# what are the fourth through seventh elements in y?
y[4:7]
# what are the second and ninth elements in y?
y[c( 2,9 )]
# change the fifth through eighth elements in y to 0.
...
For example, let's take a look at the `memer` package. The Github repository for the package is: https://github.com/sctyner/memer. Note: this package has some dependencies that are fairly large. 
  ...
  + Try to load from CRAN using `install.packages( "member" )`. What happens?  
