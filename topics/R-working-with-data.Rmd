...
Let's work through an example. Start by downloading the "R_Workshop_data.csv" file from this [link](r-workshop-data.csv) on the [RWorkshop website](https://jacobtnyoung.github.io/RWorkshop/).
...
dat <- read.csv( 
  "https://raw.githubusercontent.com/jacobtnyoung/RWorkshop/main/r-workshop-data.csv", header = TRUE, as.is = TRUE, na.strings = "." 
  )
dat
```
